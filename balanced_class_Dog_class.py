...
#train class balancing feature to give equal priority to each class using imbalancer
...
trainlabels=array(labels['breed'])
#testlabels=array(testlabel)
le=LabelEncoder()
trainlabelss=le.fit_transform(trainlabels)
...
#additional_feature from other file
from imblearn.over_sampling import RandomOverSampler
ros=RandomOverSampler()
x_resampled,y_resampled=ros.fit_sample(x_train_data,trainlabelss)
